...
<head>
    ...
    <title>Painel de Produtos - Loja Senac</title>
    <!-- Font Awesome -->
...
<div class="container">
    ...
    <div class="top-actions">
        <form method="POST" action="admin-produtos.php" class="search-card">
            ...
            <tr>
                ...
                <td>
                    <div class="actions" style="justify-content: center;">
                        ...
                        <a href="admin-produtos.php?excluir=<?= $produto->id ?>" class="action-icon delete" title="Excluir" onclick="return confirm('Tem certeza que deseja excluir este produto?');"><i class="fa-solid fa-trash-can"></i></a>
                    </div>
                </td>
            </tr>
            <?php endforeach; ?>
